describe("template spec", () => {
	describe("Free version", () => {
		it("should not enable the next button when the email is invalid", () => {
			...
			cy.get("[data-cy='companyEmail']").type("JohnDoe@example{enter}");
			cy.get("[data-cy='companyName']").type("example.com{enter}");
			cy.get("[data-cy='companyNumber']").type("93056589{enter}");
			cy.get("[data-cy='taxNumber']").type("nl123456789b01{enter}");
			...
			cy.get("[data-cy='zipCode']").type("1234AB{enter}");
			cy.get("[data-cy='houseNumber']").type("1{enter}");
		...
		it("should enable the manual address details when the ZIP code is invalid", () => {
			...
			cy.get("[data-cy='companyEmail']").type("JohnDoe@example.com{enter}");
			cy.get("[data-cy='companyName']").type("example.com{enter}");
			cy.get("[data-cy='companyNumber']").type("93056589{enter}");
			cy.get("[data-cy='taxNumber']").type("nl123456789b01{enter}");
			...
			cy.get("@streetName").type("Placeholder street{enter}");
			cy.get("@city").type("Placeholder city{enter}");
			cy.get("@country").type("Placeholder country{enter}");
		...
		it("should make it through the entire application", () => {
			...
			cy.get("[data-cy='organizationName']").type("Example corp.{enter}");
			...
			cy.get("[data-cy='iban']").type("GB82WEST12345698765432{enter}");
			cy.get("[data-cy='invoiceNumber']").type("00001{enter}");
